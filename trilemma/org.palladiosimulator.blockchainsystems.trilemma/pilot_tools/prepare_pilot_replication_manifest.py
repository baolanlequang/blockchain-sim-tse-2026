...
def main() -> int:
    ...
    ap.add_argument("--rs", type=int, default=8, help="Network instances per pilot pair")
    ap.add_argument("--re", type=int, default=4, help="Event replications per network instance")
