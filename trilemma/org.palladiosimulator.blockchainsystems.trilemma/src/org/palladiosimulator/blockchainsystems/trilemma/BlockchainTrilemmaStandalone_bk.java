...
public class BlockchainTrilemmaStandalone_bk {
	private final Logger logger = Logger.getLogger(BlockchainTrilemmaStandalone_bk.class);
	...
	public BlockchainTrilemmaStandalone_bk(String modelProjectName,
