...
public class TrilemmaSimulationFactory_bk implements Simulation {
	
	private Simulation simulation;
	
	public TrilemmaSimulationFactory_bk() {
		
	}
	
	public TrilemmaSimulationFactory_bk(SimulationParameters simulationParameters, Map<String, String> configuration) {
