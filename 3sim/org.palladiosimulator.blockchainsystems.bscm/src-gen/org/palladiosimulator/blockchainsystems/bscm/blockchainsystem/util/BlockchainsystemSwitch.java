...
public class BlockchainsystemSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case BlockchainsystemPackage.BLOCKCHAIN_SYSTEM: {
			...
			if (result == null)
				result = caseEntity(blockchainSystem);
			if (result == null)
				result = caseIdentifier(blockchainSystem);
			if (result == null)
				result = caseNamedElement(blockchainSystem);
			if (result == null)
				result = casePCMBaseClass(blockchainSystem);
			if (result == null)
				result = casePCMClass(blockchainSystem);
			if (result == null)
		...
		case BlockchainsystemPackage.BLOCKCHAIN_SYSTEM_SPECIFICATION: {
			...
			if (result == null)
				result = caseEntity(blockchainSystemSpecification);
			if (result == null)
				result = caseIdentifier(blockchainSystemSpecification);
			if (result == null)
				result = caseNamedElement(blockchainSystemSpecification);
			if (result == null)
				result = casePCMBaseClass(blockchainSystemSpecification);
			if (result == null)
				result = casePCMClass(blockchainSystemSpecification);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
