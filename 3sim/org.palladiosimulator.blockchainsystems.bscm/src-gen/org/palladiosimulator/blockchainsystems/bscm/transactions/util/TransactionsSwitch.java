 ...
 * @generated
 */
public class TransactionsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case TransactionsPackage.TRANSACTIONS_SPECIFICATION: {
			...
			if (result == null)
				result = caseEntity(transactionsSpecification);
			if (result == null)
				result = caseIdentifier(transactionsSpecification);
			if (result == null)
				result = caseNamedElement(transactionsSpecification);
			if (result == null)
				result = casePCMBaseClass(transactionsSpecification);
			if (result == null)
				result = casePCMClass(transactionsSpecification);
			if (result == null)
		...
		case TransactionsPackage.TRANSACTION_PROPERTIES_SPECIFICATION: {
			...
			if (result == null)
				result = caseEntity(transactionPropertiesSpecification);
			if (result == null)
				result = caseIdentifier(transactionPropertiesSpecification);
			if (result == null)
				result = caseNamedElement(transactionPropertiesSpecification);
			if (result == null)
				result = casePCMBaseClass(transactionPropertiesSpecification);
			if (result == null)
				result = casePCMClass(transactionPropertiesSpecification);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case TransactionsPackage.TRANSACTION_PROPERTIES_SPECIFICATION_VALUE: {
			...
			if (result == null)
				result = caseEntity(transactionPropertiesSpecificationValue);
			if (result == null)
				result = caseIdentifier(transactionPropertiesSpecificationValue);
			if (result == null)
				result = caseNamedElement(transactionPropertiesSpecificationValue);
			if (result == null)
				result = casePCMBaseClass(transactionPropertiesSpecificationValue);
			if (result == null)
				result = casePCMClass(transactionPropertiesSpecificationValue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
