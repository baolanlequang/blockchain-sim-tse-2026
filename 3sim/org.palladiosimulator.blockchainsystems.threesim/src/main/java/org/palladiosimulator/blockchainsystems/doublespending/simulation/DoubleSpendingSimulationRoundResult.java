...
public class DoubleSpendingSimulationRoundResult {
	...
	public DoubleSpendingSimulationRoundResult(int numberOfAbstentedVotes, int numberOfAttackerWonVotes, int numberOfSystemWonVotes, int numberOfBTONotIncludedVotes, int forkedBlockLength) {
	...
	public static DoubleSpendingSimulationRoundResult create(Set<SimulationWinnerVote> winnerVotes, int forkedBlockLength) {
		...
		return new DoubleSpendingSimulationRoundResult(
				numberOfAbstentedVotes,
				numberOfAttackerWonVotes,
				numberOfSystemWonVotes,
				numberOfBTONotIncludedVotes,
