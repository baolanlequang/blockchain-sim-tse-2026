...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.blockchainsystems.bscm.geographicalregions.GeographicalRegion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GeographicalRegionItemProvider extends EntityItemProvider {
	/**
	...
	protected void addRegionNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_GeographicalRegion_RegionName_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_GeographicalRegion_RegionName_feature",
								"_UI_GeographicalRegion_type"),
						GeographicalregionsPackage.Literals.GEOGRAPHICAL_REGION__REGION_NAME, true, false, false,
	...
	public String getText(Object object) {
		String label = ((GeographicalRegion) object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GeographicalRegion.class)) {
