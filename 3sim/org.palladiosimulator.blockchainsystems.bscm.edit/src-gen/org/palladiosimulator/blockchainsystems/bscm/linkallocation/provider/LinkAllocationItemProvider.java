...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.blockchainsystems.bscm.linkallocation.LinkAllocation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkAllocationItemProvider extends EntityItemProvider {
	/**
	 ...
	 * @generated
	 */
	public LinkAllocationItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns LinkAllocation.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LinkAllocation"));
	}
	...
	public String getText(Object object) {
		String label = ((LinkAllocation) object).getId();
		return label == null || label.length() == 0 ? getString("_UI_LinkAllocation_type")
				: getString("_UI_LinkAllocation_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(LinkallocationPackage.Literals.LINK_ALLOCATION__LATENCY_SPECIFICATION,
						LinkallocationFactory.eINSTANCE.createDynamicLinkLatencySpecification()));

		newChildDescriptors
				.add(createChildParameter(LinkallocationPackage.Literals.LINK_ALLOCATION__LATENCY_SPECIFICATION,
						LinkallocationFactory.eINSTANCE.createStaticLinkLatencySpecification()));

		newChildDescriptors
				.add(createChildParameter(LinkallocationPackage.Literals.LINK_ALLOCATION__THROUGHPUT_SPECIFICATION,
						LinkallocationFactory.eINSTANCE.createDynamicLinkThroughputSpecification()));
